...
function displayCourses() {
    ...
    courses.forEach((course, index) => {
        ...
        courseItem.innerHTML = `
            <ul><li><span>Title: ${course.title}, Credit Hours: ${course.credit}, Grade: ${course.grade}</span>
            <button class="delete-button" onclick="deleteCourse(${index})">Delete</button> </li></ul><hr>
        `;
